...
export default async function NewWordPage(props: PageProps<"/words/new">) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-bg px-6 py-16">
      <div className="w-full max-w-[520px] rounded-xl border border-line bg-surface p-8 shadow-[0_0_40px_-20px_var(--color-accent)]">
        <p className="mb-1 font-mono text-[10px] tracking-[0.25em] text-accent uppercase">New entry</p>
